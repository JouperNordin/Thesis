...
public class Main {
	...
	//# If you want to test the bigger data sets the VM run configuration argument need to increase the stack size
	//# -Xss(size)m
	//# To run the test case below, in order and decreased order the VM argument must be set to 
	//# -Xss2048m "Is the minimum for Data_16777216" Which enable you to test all cases up to this size of elements.
	//# if you want to test bigger data sets you will have to find a suitable stack size to satisfy quick sort worst case
	//# scenario.
	
	public static void main(String[] args) {		
		int nrOfParallelismLevels = 2;
		int nrOfTestCases = 7;
		int nrOfTests = 1;
		int nrOffalseMessages = 0;
		String[] paths = new String[]{"Random Order/","Increased Order/", "Decreased Order/"};
		
		for(int p = 0; p<=nrOfParallelismLevels; p++){
