...
public class Main {
	/*
	 * Param 1: Array att sortera
	 * Param 2: Tom temp array med samma längd som array
	 * Param 3: Antal siffror i största talet, ex. 4096 = 4
	 * Param 4: Level, som vanligt
	 * Param 5: Antal "buckets", msd+1 ex. 4096 = 5. Undatag för 1048576 = 11 och 16777216 = 17
	 * Param 6: Modulus, 100 för 1048576 och 16777216. Annars 10. 
	 */
	...
	public static void main(String[] args) {		
		...
		for(int p = 0; p<=nrOfParallelismLevels; p++){
			...
			//Inte vackert, men tror att det funkar
			int param3 = 0;
			int param5 = 0;
			int param6 = 0;
			...
			for(int i = 0; i<nrOfTestCases; i++){
				for(int j = 0; j<nrOfTests; j++){
					...
					if(data != null){
						...
						RadixSort.sort(data, temp, param3, p, param5, param6);
